...
experiment_name="MODIFIED_INIT_SHARPA_LOWER_TABLE_HEIGHT_WITH_MOVING_AVERAGE"
...
task.env.useHandRelativeControl=False \
task.env.useArmRelativeControl=False \
task.env.tableHeight=0.11 \
