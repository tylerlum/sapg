...
CUSTOM_EXPERIMENT_NAME="NO_JOINT_ACCELERATION_PENALTY_CONTROL_FREQUENCY_2"
WANDB_GROUP="NEW_RUN"

WANDB_ENTITY="kk837"
WANDB_PROJECT="POSE_REACHING"
OBJECT_TYPE="cuboid"
...
task.env.jointVelocityPenaltyScale=0.001 \
task.env.jointAccelerationPenaltyScale=0.000 \
