...
CUSTOM_EXPERIMENT_NAME="NEW_FT_FixedSize_${fixedSizeKeypointReward}_Force_${forceOnlyWhenLifted}_Scale_${forceScale}"
WANDB_GROUP="FINETUNING_1x"
...
CHECKPOINT=/share/portal/kk837/sapg/train_dir/customPretraining/FINETUNE_5x/FINETUNE_5x_SLOW_SPEED_ADD_ACTION_DELAY_2026-01-05_02-10-22/runs/00_FINETUNE_5x_SLOW_SPEED_ADD_ACTION_DELAY_2026-01-05_02-10-22/last/model.pth
