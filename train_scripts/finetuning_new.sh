...
export foldername="2025-11-12_sharpa_hammer_2_coacd"
export filename_without_ext="FINETUNE_NEW_POLICY"
...
export CUBOID_PRETRAINED_CHECKPOINT=/share/portal/kk837/sapg/train_dir/allegro_kuka_reorientation/FINETUNE_SHARPA_dofSpeedScale_10_armMovingAverage_0.1_handMovingAverage_0.1/runs/00_FINETUNE_SHARPA_dofSpeedScale_10_armMovingAverage_0.1_handMovingAverage_0.1/last/model.pth
...
export CHECKPOINT=/share/portal/kk837/sapg/train_dir/allegro_kuka_reorientation/FINETUNE_SHARPA_dofSpeedScale_10_armMovingAverage_0.1_handMovingAverage_0.1/runs/00_FINETUNE_SHARPA_dofSpeedScale_10_armMovingAverage_0.1_handMovingAverage_0.1/last/model.pth
export URDF=urdf/kuka_allegro_description/iiwa14_left_sharpa_between.urdf
...
task.env.asset.kukaAllegro=${URDF} \
...
# ~task.task.randomization_params \
# ++task.task.randomization_params.frequency=720 \
# ++task.task.randomization_params.actor_params.object.scale.range=[0.9,1.1] \
# ++task.task.randomization_params.actor_params.object.scale.operation=scaling \
# ++task.task.randomization_params.actor_params.object.scale.distribution=uniform \
# ++task.task.randomization_params.actor_params.object.scale.setup_only=True \
