...
orig_obj_path = Path("/home/tylerlum/github_repos/sapg/assets/urdf/tyler_objects/whiteboard_eraser/source/Yuta_Eraser_Mesh.obj")
new_obj_path = Path("/home/tylerlum/github_repos/sapg/assets/urdf/tyler_objects/whiteboard_eraser/source/Yuta_Eraser_Mesh_modified.obj")
...
T = np.eye(4)
R = Rotation.from_euler('xyz', [45, -45, -10], degrees=True).as_matrix()
T[:3, :3] = R
